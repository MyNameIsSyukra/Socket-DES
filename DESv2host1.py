...
if __name__ == "__main__":
	while 1:
		...
		ecr = encrypt_client(pt,key)
		client_socket.send(ecr.encode())
		print(f"Encrypt yang dikirim ke server: {ecr}")

		ciphertext = client_socket.recv(1024).decode()
		print(f"Ciphertext yang diterima dari server: {ciphertext}")
		plaintext = decrypt_client(ciphertext,key)
		print(f"plaintText dari host2 {plaintext}")
