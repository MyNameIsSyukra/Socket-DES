...
def decrypt_server(cipher_text,key):
	# pt = input("masukan 16 karakter dari 1-9 A-F: ")
	# key = input("ini untuk Key dengan aturan yang sama: ")
...
if __name__ == "__main__":
	while 1:
		...
		# Menerima encrypt dari host1
		ecr_client = client_socket.recv(1024).decode()
		print(f"CipherText yang diterima dari client: {ecr_client}")
		plainthost2 = decrypt_server(ecr_client,key)
		print(f"plainText dari client yang telah di decrypt : {plainthost2}")

		pt = input("masukan 16 karakter dari 1-9 A-F: ")
		# Mengirim Encrypt dari host2
		cipher_text = encrypt_server(pt,key)
